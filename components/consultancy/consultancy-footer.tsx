...
export function ConsultancyFooter() {
  return (
    <footer className="bg-[var(--datastitch-navy)] px-6 pb-10 pt-16 text-white sm:px-10 lg:px-16">
      <div className="mx-auto max-w-6xl space-y-12">
        ...
        <div className="flex flex-col items-start justify-between gap-4 rounded-full border border-white/15 bg-white/5 px-6 py-3 sm:flex-row sm:items-center">
          ...
          <button className="inline-flex items-center gap-2 rounded-full bg-[var(--datastitch-accent)] px-5 py-2 text-sm font-semibold text-[var(--datastitch-accent-ink)] transition hover:brightness-110">
            Subscribe
          ...
          <div className="space-y-4 sm:col-span-2 lg:col-span-1">
            <div className="flex items-center gap-2">
              <Image
                ...
                height={28}
              />
              <span className="text-base font-bold">Suchure</span>
            </div>
        ...
        <div className="flex flex-col items-start justify-between gap-3 border-t border-white/10 pt-6 sm:flex-row sm:items-center">
          <p className="text-xs text-white/40">
            © 2026 Suchure AI &amp; Data. All rights reserved. Registered in the United Kingdom.
          </p>
          {/* Social icons */}
