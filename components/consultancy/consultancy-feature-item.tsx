...
export function ConsultancyFeatureItem({ title, description }: ConsultancyFeatureItemProps) {
  return (
    <div className="flex gap-3 rounded-2xl bg-gray-50/80 p-4">
      {/* Icon */}
      <div className="mt-0.5 flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-xl bg-[var(--datastitch-accent)]/15">
        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="text-[var(--datastitch-accent-ink)]">
