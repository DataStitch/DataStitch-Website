    ...
    <section className="bg-[var(--datastitch-bg)] px-6 py-20 sm:px-10 lg:px-16">
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mt-8 grid gap-6 md:grid-cols-2 xl:grid-cols-3">
          {courses.map((course) => (
            <article key={course.id} className="rounded-2xl border border-[var(--datastitch-border)] bg-white">
              <div className="h-44 rounded-t-2xl bg-[var(--datastitch-soft)]" />
              <div className="space-y-4 p-5">
                <div className="flex flex-wrap items-center gap-2 text-xs">
                  ...
                  <span className="text-[var(--datastitch-muted)]">{course.rating}</span>
                </div>
                ...
                <button className="w-full rounded-full border border-[var(--datastitch-border)] px-4 py-2 text-sm font-medium text-[var(--datastitch-ink)]">
                  View Course
                </button>
              </div>
            </article>
