...
export function ConsultancySection() {
  return (
    <section className="bg-[var(--datatriad-navy)] px-6 py-20 text-white sm:px-10 lg:px-16">
      <div className="mx-auto max-w-7xl space-y-10">
        <div className="grid gap-8 lg:grid-cols-2 lg:gap-14">
          <div className="space-y-5">
            <span className="inline-flex rounded-full border border-[var(--datatriad-accent)]/30 bg-[var(--datatriad-accent)]/12 px-4 py-1 text-sm font-semibold text-[var(--datatriad-accent)]">
              datatriad Consultancy
            </span>
            <h2 className="max-w-xl text-balance text-4xl font-semibold leading-tight sm:text-5xl">
              AI <span className="text-[var(--datatriad-accent)]">governance </span> isn&apos;t optional. Your evidence shouldn&apos;t be improvised.
            </h2>
            <button className="inline-flex rounded-full bg-[var(--datatriad-accent)] px-6 py-3 text-sm font-semibold text-[var(--datatriad-accent-ink)] transition hover:-translate-y-0.5 hover:brightness-110">
        ...
        <div className="rounded-3xl border border-white/10 bg-gradient-to-br from-white/5 via-white/[0.03] to-transparent p-4 shadow-[0_24px_80px_rgba(0,0,0,0.35)] sm:p-5">
          <div className="grid gap-4 lg:grid-cols-12">
                  ...
                  {trendBars.map((height, index) => {
                    ...
                    return (
                      <div key={index} className="relative flex-1">
                        {isActive ? (
                          <>
                            <div className="absolute -top-13 left-1/2 -translate-x-1/2 rounded-full bg-[var(--datatriad-accent)] px-3 py-1 text-[11px] font-semibold text-[var(--datatriad-accent-ink)] shadow-[0_0_12px_rgba(61,223,208,0.5)]">
                              75% Optimal
                            </div>
                            <div className="absolute -top-2 left-1/2 h-1.5 w-1.5 -translate-x-1/2 rounded-full bg-[var(--datatriad-accent)]" />
                          </>
                        ) : null}
                        <div
            ...
            <div className="space-y-4 lg:col-span-4">
              ...
              <article className="rounded-2xl border border-white/20 bg-white/[0.04] p-5">
                <div className="mb-4 h-5 w-5 rounded-full border border-[var(--datatriad-accent)]/70" />
            ...
            <article className="rounded-2xl border border-white/20 bg-white/[0.04] p-5 lg:col-span-7">
              <div className="grid items-center gap-6 sm:grid-cols-[1fr_auto]">
                ...
                <div className="mx-auto grid h-30 w-30 place-items-center rounded-full bg-[conic-gradient(var(--datatriad-accent)_0_75%,rgba(255,255,255,0.28)_75%_85%,rgba(255,255,255,0.12)_85%_100%)] p-4">
