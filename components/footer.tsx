export function FooterSection() {
  return (
    <footer className="bg-[var(--datatriad-navy)] px-6 py-14 text-white sm:px-10 lg:px-16">
      <div className="mx-auto grid max-w-6xl gap-10 md:grid-cols-4">
        <div className="md:col-span-2">
          <h3 className="text-2xl font-bold">datatriad</h3>
      ...
      <div className="mx-auto mt-10 max-w-6xl border-t border-white/15 pt-6 text-xs text-white/60">
        © {new Date().getFullYear()} datatriad. All rights reserved.
      </div>
    </footer>
  );
}
